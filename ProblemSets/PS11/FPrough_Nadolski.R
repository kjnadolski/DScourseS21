...
library(purrr)
    ...
    # OLS estimation: 
        ...
        ols.craigslist <- lm(logrent ~ sqft + bdrms + p.QDAP + wordcount + t.wordcount + t.direction, data = craigslist.clean)
        irls.craigslist <- rlm(logrent ~ sqft + bdrms + p.QDAP + wordcount + t.wordcount + t.direction, data = craigslist.clean)
